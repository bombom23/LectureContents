package com.example.demo.newcontroller.jpa;
...
import com.example.demo.newcontroller.vue.sesion.UserInfo;
import com.example.demo.service.jpa.MemberTestService;
...
@CrossOrigin(origins = { "http://localhost:9999", "http://localhost:8080" }, allowedHeaders = "*")
